...
public class ValidationRequest {
    ...
    public static void validateMeasure (Double measure, String measureName, Integer max) {
        ...
        if(measure == null) { throw new ValidationException("A medida de " + measureName + " do cômodo não pode estar vazia."); }

        if(measure < 0 ) { throw new ValidationException("A medida de " + measureName + " do cômodo não pode ser negativa."); }
